...
# por metro cúbico (m³) de produto final.

TRACOS = {
    "concreto_magro": {
        "descricao": "Concreto Magro (para lastro/regularização)",
        "cimento_kg_m3": 130.0,  # OK
        "areia_m3_m3": 0.65,
        "brita_m3_m3": 0.85,
        "cal_kg_m3": 0.0,
    ...
    "concreto_c25": {
        ...
        "cimento_kg_m3": 320.0,  # padrão de obra
        "areia_m3_m3": 0.55,
        "brita_m3_m3": 0.75,
        "cal_kg_m3": 0.0,
    ...
    "concreto_c30": {
        ...
        "cimento_kg_m3": 360.0,  # leve ajuste (C30 normalmente 350-380 kg/m3)
        "areia_m3_m3": 0.50,
        "brita_m3_m3": 0.70,
        "cal_kg_m3": 0.0,
    ...
    "argamassa_chapisco": {
        ...
        "cimento_kg_m3": 400.0,  # chapisco costuma ser mais rico: 350-450 kg/m3
        "areia_m3_m3": 1.0,  # areia grossa
        "brita_m3_m3": 0.0,
        "cal_kg_m3": 0.0,
    ...
    "argamassa_assentamento": {
        ...
        "cimento_kg_m3": 180.0,  # aceitável (180-200)
        "areia_m3_m3": 0.95,
        "brita_m3_m3": 0.0,
        "cal_kg_m3": 90.0,  # aceitável (80-110)
        "agua_litros_m3": 200.0,
    },
    "argamassa_reboco_interno": {
        "descricao": "Argamassa de Reboco Interno (Traço recomendado 1:1:6 volumétrico)",
        "cimento_kg_m3": 210.0,  # ajustar para 200-220 para 1:1:6
        "areia_m3_m3": 1.00,  # areia fina
        "brita_m3_m3": 0.0,
        "cal_kg_m3": 160.0,  # cal para 1:1:6 fica alta (140-180 kg/m3)
        "agua_litros_m3": 200.0,
    },
}


# Dicionário com dados auxiliares para conversão
